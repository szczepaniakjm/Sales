...
public class OrderTabDaoImp implements OrderTabDao {
    ...
    public void delete(Integer id) {
        ...
        try (PreparedStatement prep = connection.prepareStatement(sqlDelete)) {
            ...
            System.err.println("ERROR WHILE DELETING FROM TABLE ORDERTAB [ERROR MESSAGE: " + e.getMessage() + ", ERROR CAUSE: " + e.getCause() +  " ]");
        }
    ...
    public Optional<OrderTab> findOne(Integer id) {
        ...
        try {
            ...
            System.err.println("ERROR WHILE SELECTING FROM TABLE ORDERTAB, ID = " + id + " [ERROR MESSAGE: " + e.getMessage() + ", ERROR CAUSE: " + e.getCause() +  " ]");
        } finally {
            try {
                prep.close();
                resultSet.close();
